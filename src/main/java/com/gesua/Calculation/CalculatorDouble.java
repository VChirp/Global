...
public class CalculatorDouble {
    ...
    static final double T1par = 102.66;

    public CalculatorDouble() throws IOException, URISyntaxException {
    }
    ...
    static class Report {
        ...
        Map<Double, WaterStats> mapWater = StatsParser.toWaterMapByTemperature(StatsParser.parserWater(WATERFILE));
        Map<Double, TechStats> techStatsMap = StatsParser.toTechsMapByF(StatsParser.parserTech(TECHSFILE));

        public double getDvn() {
            return Dvn;
        }

        public double getdRaschetTeploobTrubki() {
            return dRaschetTeploobTrubki;
        }

        public double getFvn() {
            return fvn;
        }

        public double getFvnNTrubok() {
            return fvnNTrubok;
        }

        public double getV1trubka() {
            return v1trubka;
        }
        ...
        public double getdTser() {
            return dTser;
        }

        public double getT2ser() {
            return T2ser;
        }

        public double getNyuT2ser() {
            return nyuT2ser;
        }
        ...
        public double getAlphaRuflen() {
            return alphaRuflen;
        }

        public double getAlphaGorizontSkorostnaya() {
            return alphaGorizontSkorostnaya;
        }

        public double getkPoRovnoy() {
            return kPoRovnoy;
        }

        public double getT2sred() {
            return t2sred;
        }
        ...
        public double getFpo45min() {
            return Fpo45min;
        }

        public double getFvodu() {
            return Fvodu;
        }

        public double getFvn_Fvodu() {
            return Fvn_Fvodu;
        }

        public double getDekv() {
            return Dekv;
        }

        public double getFvnVodu() {
            return fvnVodu;
        }

        public double getDekvVnTrubok() {
            return dekvVnTrubok;
        }

        public double getdPar() {
            return dPar;
        }
        ...
        public double getRePar() {
            return RePar;
        }

        public double getFnar() {
            return fnar;
        }

        public double getFnarTrubok() {
            return fnarTrubok;
        }

        public double getDnar() {
            return dnar;
        }

        public double getLtrub() {
            return Ltrub;
        }

        public double getLyamdaStali() {
            return lyamdaStali;
        }

        public double getTolshinaStenki() {
            return tolshinaStenki;
        }

        public double getTeploprovodimistStali() {
            return teploprovodimistStali;
        }

        public double getTeploprovodimostNakipi() {
            return teploprovodimostNakipi;
        }

        public double getKoefRiflen() {
            return KoefRiflen;
        }

        public double getbNaYjim() {
            return bNaYjim;
        }

        public double getbZagr() {
            return bZagr;
        }

        public double getPnar() {
            return Pnar;
        }

        public double getPopar() {
            return popar;
        }
        ...
        public double getNuPar() {
            return NuPar;
        }

        public double getAlphaPar() {
            return AlphaPar;
        }
        ...
        public double getReEkv() {
            return reEkv;
        }

        public double getSoprLamda() {
            return soprLamda;
        }
        ...
        public double getPrpar() {
            return Prpar;
        }

        public double getLamdaKond() {
            return lamdaKond;
        }

        public double getPoKondensata() {
            return poKondensata;
        }

        public double getMuPar() {
            return MuPar;
        }

        public double getMuKond() {
            return MuKond;
        }
        ...
        final double po;//Table
        final double cp;//Table
        ...
        final double primayemayaTmperaturaKondensata;
        ...
        final double RePar;
        final double nuPar;
        final double AlphaPar;
        final double A;
        final double AlphaGorKondNepodPar;
        final double t1stenki;
        final double qNorm;

        final double reEkv;
        final double soprLamda;
        final double dPot;
//        final double ksiSujeniya;
//        final double dpTotal;

        final double vnPlTrubki;
        final double narPlTrubki;


        Report(final double nTrubok,
               final double t2sht,
               final double G,
               final double T2vuh) throws IOException, URISyntaxException {

            fnar = fnar(dnar);
            Fvn = Fvn(Dvn);
            Fvn_Fvodu = Fvn_Fvodu(Fvn, fnar, nTrubok);
            Dekv = Dekv(Fvn_Fvodu);
            primayemayaTmperaturaKondensata = primayemayaTmperaturaKondensata(T1par);
            ...
            k = k(alpha, tolshinaStenki, bZagr, alphaGorizontSkorostnaya);
            Fpo45min = fPo45min(qPo45min, dTser, k);
            F = F(q, dTser, k);
            dPar = dPar(q, r);
            v = v(dPar, popar, Fvn_Fvodu);
            RePar = RePar(v, Dekv, NuPar);
            nuPar = nuPar(Re, Prpar);
            AlphaPar = AlphaPar(nuPar, lamdaKond, Dekv);
            A = A(lamdaKond, r, poKondensata, popar, NuPar);
            qNorm = qNorm(k, dTser);
            t1stenki = t1stenki(primayemayaTmperaturaKondensata, qNorm, alphaGorizontSkorostnaya);
            AlphaGorKondNepodPar = AlphaGorKondNepodPar(A, dnar, T1par, t1stenki);

            reEkv = reEkv(vNtrubok, dekvVnTrubok, nu);
            soprLamda = soprLamda(dekv, reEkv);
            dPot = dPot(soprLamda, Ltrub, dekvVnTrubok, vNtrubok, po);

            vnPlTrubki = vnPlTrubki(dvn, Ltrub);
            narPlTrubki = narPlTrubki(dnar, Ltrub);
        }
...
//        }
        ...
        private double Re(double vNtrubok, double dvn, double Nyu) {
            return vNtrubok * dvn / (Nyu * Math.pow(10, -6));
        }
        ...
        private double alpha(double nu, double lamda, double dvn) {
            return nu * (lamda * Math.pow(10, -2)) / dvn;
        }
        ...
        private double alphaGorizontSkorostnaya(double T1par, double dnar) {
            return 4950 + 58.5 * primayemayaTmperaturaKondensata - (0.18 * Math.pow(primayemayaTmperaturaKondensata, 2)) / (Math.pow(((T1par - primayemayaTmperaturaKondensata) / 3 / dnar), 0.25));
        }
        ...
        private double k(double alpha, double tolshinaStenki, double bzagr, double alphaGorizontSkorostnaya) {
            return 1 / (1 / alpha + tolshinaStenki / 16.2 + bzagr / 1.16 + 1 / alphaGorizontSkorostnaya);
        }
        ...
        //        From table
        private double p(double temperature) {
            return mapWater.get(temperature).p;
        }

        private double ro(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).ro;
        }

        private double h(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).h;
        }

        private double cp(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).cp;
        }

        private double lamda(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).lamda;
        }

        private double a(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).a;
        }

        private double mu(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).mu;
        }

        private double nu(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).nu;
        }

        private double beta(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).beta;
        }

        private double sigma(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).sigma;
        }

        private double pr(double temperature) {
            return mapWater.get(rounderToUp(temperature, -1)).pr;
        }
...
//    Пар
        ...
        private double primayemayaTmperaturaKondensata(double T1par) {
            return T1par - 5;
        }

        //    Сопротивление по воде

        private double t1stenki(double primayemayaTmperaturaKondensata, double qNorm, double alphaGorizontSkorostnaya) {
            return primayemayaTmperaturaKondensata - qNorm / alphaGorizontSkorostnaya;
        }
        ...
        private double vnPlTrubki(double dvn, double ltrub) {
            return dvn * PI * ltrub;
        }

        private double narPlTrubki(double dnar, double ltrub) {
            return dnar * PI * ltrub;
        }


        //Linear interpolation
        public WaterStats getWaterStatsUsinLinearInterpolation(double temperature){
            WaterStats upperStats = mapWater.get(rounderToUp(temperature,-1));
            WaterStats downerStats = mapWater.get(rounderToDown(temperature, -1));
    ...
    //ROUNDER
    public static double rounderToUp(double number, double precise) {
        precise = Math.pow(10, precise);
        number = Math.ceil(number * precise) / precise;
        return number;
    }

    public static double rounderToDown(double number, double precise) {
        precise = Math.pow(10, precise);
        number = Math.floor(number * precise) / precise;
        return number;
    }

    public static double linearInterpolation(double temp ,double upperTemp, double downerTemp, double x, double y){
        return x + (y - x) / (upperTemp - downerTemp) * (temp - downerTemp);
    }
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        final double nTrubok = 37;
        final double t2sht = 35;// Т2вх
        final double G = 4.16;
        final double T2vuh = 50;

        Report report = new Report(nTrubok, t2sht, G, T2vuh);
